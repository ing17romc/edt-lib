import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as g}from"./index-CgfFrydU.js";import"./_commonjsHelpers-CqkleIqs.js";const b=({label:o,checked:s=!1,disabled:n=!1,onChange:c,className:e="",...t})=>{const[r,R]=g.useState(s),w=()=>{if(!n){const k=!r;R(k),c==null||c(k)}};return a.jsxs("label",{className:`check-button ${e} ${n?"disabled":""}`,children:[a.jsx("input",{type:"checkbox",checked:r,onChange:w,disabled:n,className:"check-button__input",...t}),a.jsx("span",{className:"check-button__checkmark"}),o&&a.jsx("span",{className:"check-button__label",children:o})]})};b.__docgenInfo={description:`CheckButton - Un componente de botón de verificación personalizable.
...
}`,...(q=(O=i.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var N,T,E;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    label: 'Opción grande',
    className: 'check-button--large'
  }
}`,...(E=(T=p.parameters)==null?void 0:T.docs)==null?void 0:E.source}}};var _,I,B;u.parameters={...u.parameters,docs:{...(_=u.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
...
}`,...(G=(D=m.parameters)==null?void 0:D.docs)==null?void 0:G.source}}};var V,H,L;h.parameters={...h.parameters,docs:{...(V=h.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(L=(H=h.parameters)==null?void 0:H.docs)==null?void 0:L.source}}};const P=["Default","Checked","Disabled","Large","Small","Interactive","Group"];export{d as Checked,l as Default,i as Disabled,h as Group,m as Interactive,p as Large,u as Small,P as __namedExportsOrder,K as default};
