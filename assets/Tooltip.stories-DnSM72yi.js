import{a as e,n as t}from"./chunk-BneVvdWh.js";import{O as n,a as r,i,o as a}from"./iframe-BoT0I_bJ.js";var o,s,c,l,u=t((()=>{o=`_wrapper_apg5i_1`,s=`_tooltip_apg5i_7`,c=`_arrow_apg5i_21`,l={wrapper:o,tooltip:s,arrow:c,"tooltip--top":`_tooltip--top_apg5i_27`,"tooltip--bottom":`_tooltip--bottom_apg5i_41`,"tooltip--left":`_tooltip--left_apg5i_55`,"tooltip--right":`_tooltip--right_apg5i_69`}})),d,f,p,m=t((()=>{d=e(n(),1),a(),u(),f=i(),p=({content:e,placement:t=`top`,disabled:n=!1,children:i,className:a,...o})=>{let[s,c]=(0,d.useState)(!1);return n?(0,f.jsx)(f.Fragment,{children:i}):(0,f.jsxs)(`div`,{className:r(l.wrapper,a),onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),onFocus:()=>c(!0),onBlur:()=>c(!1),...o,children:[i,s&&(0,f.jsxs)(`div`,{role:`tooltip`,className:r(l.tooltip,l[`tooltip--${t}`]),children:[e,(0,f.jsx)(`span`,{className:l.arrow})]})]})},p.__docgenInfo={description:`Tooltip component that displays additional information when hovering over an element.\r
\r
