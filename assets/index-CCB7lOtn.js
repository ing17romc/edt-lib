import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{r as A,R as C}from"./index-D4lIrffr.js";import{c}from"./index-_oZgBBUR.js";const M="_selectorWrapper_1mv78_1",V="_selectorLabel_1mv78_11",w="_selectorContainer_1mv78_20",O="_selector_1mv78_1",U="_selectorIcon_1mv78_43",D="_helperText_1mv78_116",Y="_requiredIndicator_1mv78_126",k="_selectorLoading_1mv78_131",G="_selectorLoadingSpinner_1mv78_139",P="_spin_1mv78_1",e={selectorWrapper:M,"selectorWrapper--fullWidth":"_selectorWrapper--fullWidth_1mv78_7",selectorLabel:V,selectorContainer:w,selector:O,"selector--small":"_selector--small_1mv78_38",selectorIcon:U,"selector--medium":"_selector--medium_1mv78_48","selector--large":"_selector--large_1mv78_58","selector--primary":"_selector--primary_1mv78_68","selector--secondary":"_selector--secondary_1mv78_75","selector--error":"_selector--error_1mv78_85","selector--fullWidth":"_selector--fullWidth_1mv78_98",helperText:D,"helperText--error":"_helperText--error_1mv78_122",requiredIndicator:Y,selectorLoading:k,selectorLoadingSpinner:G,spin:P};var x=(r=>(r.PRIMARY="primary",r.SECONDARY="secondary",r.TERTIARY="tertiary",r.DANGER="danger",r.SUCCESS="success",r.WARNING="warning",r))(x||{}),y=(r=>(r.SMALL="small",r.MEDIUM="medium",r.LARGE="large",r))(y||{});const b=A.forwardRef(({options:r=[],label:i,helperText:d,error:l=!1,errorMessage:t,variant:h=x.PRIMARY,size:T=y.MEDIUM,fullWidth:u=!1,loading:o=!1,disabled:p=!1,className:g,placeholder:m,onChange:n,value:f,defaultValue:S,..._},q)=>{const[L,j]=C.useState(S||""),v=f!==void 0,I=v?f:L,R=c(e.selector,e[`selector--${h}`],e[`selector--${T}`],{[e["selector--error"]]:l,[e["selector--fullWidth"]]:u,[e["selector--disabled"]]:p||o},g),N=c(e.selectorWrapper,{[e["selectorWrapper--fullWidth"]]:u}),W=!!i,E=(d||l&&t)&&!o;return s.jsxs("div",{className:N,children:[W&&s.jsxs("label",{className:e.selectorLabel,children:[i,_.required&&s.jsx("span",{className:e.requiredIndicator,children:"*"})]}),s.jsxs("div",{className:e.selectorContainer,children:[s.jsxs("select",{ref:q,className:R,disabled:p||o,"aria-invalid":l,"aria-describedby":l&&t?"error-message":void 0,value:I,onChange:a=>{v||j(a.target.value),n==null||n(a)},..._,children:[m&&s.jsx("option",{value:"",disabled:!0,children:m}),r.map(a=>s.jsx("option",{value:a.value,disabled:a.disabled,children:a.label},a.value))]}),o&&s.jsx("div",{className:e.selectorLoading,children:s.jsx("div",{className:e.selectorLoadingSpinner})}),!o&&s.jsx("div",{className:e.selectorIcon,children:s.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:s.jsx("polyline",{points:"6 9 12 15 18 9"})})})]}),E&&s.jsx("div",{className:c(e.helperText,{[e["helperText--error"]]:l}),id:l?"error-message":void 0,children:l&&t?t:d})]})});b.displayName="Selector";b.__docgenInfo={description:`Componente Selector que representa un menú desplegable con múltiples opciones.
