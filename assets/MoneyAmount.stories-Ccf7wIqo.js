import{t as e}from"./iframe-YpqvHZo3.js";import{t}from"./jsx-runtime-ChNUh70B.js";import{t as n}from"./classNames-DYb3CZs3.js";e();var r={moneyAmount:`_moneyAmount_yakg1_1`},i=t(),a=({amount:e,currency:t=`USD`,decimals:a=2,locale:o=`es-CO`,showCurrency:s=!0,className:c,...l})=>{let u=new Intl.NumberFormat(o,{style:s?`currency`:`decimal`,currency:s?t:void 0,minimumFractionDigits:a,maximumFractionDigits:a}).format(e);return(0,i.jsx)(`span`,{className:n(r.moneyAmount,c),...l,children:u})};a.__docgenInfo={description:`Componente MoneyAmount que formatea y muestra valores monetarios.\r
\r
@param amount - Valor numérico a mostrar\r
@param currency - Código de moneda ISO 4217\r
@param decimals - Número de decimales\r
@param locale - Locale para el formato numérico\r
@param showCurrency - Si se muestra el símbolo de moneda`,methods:[],displayName:`MoneyAmount`,props:{amount:{required:!0,tsType:{name:`number`},description:`Valor numérico a mostrar`},currency:{required:!1,tsType:{name:`union`,raw:`'USD' | 'EUR' | 'COP' | 'MXN' | 'ARS' | 'CLP' | string`,elements:[{name:`literal`,value:`'USD'`},{name:`literal`,value:`'EUR'`},{name:`literal`,value:`'COP'`},{name:`literal`,value:`'MXN'`},{name:`literal`,value:`'ARS'`},{name:`literal`,value:`'CLP'`},{name:`string`}]},description:`Código de moneda ISO 4217\r
@default 'USD'`,defaultValue:{value:`'USD'`,computed:!1}},decimals:{required:!1,tsType:{name:`number`},description:`Número de decimales a mostrar\r
@default 2`,defaultValue:{value:`2`,computed:!1}},locale:{required:!1,tsType:{name:`string`},description:`Locale para el formato numérico\r
@default 'es-CO'`,defaultValue:{value:`'es-CO'`,computed:!1}},showCurrency:{required:!1,tsType:{name:`boolean`},description:`Si muestra el símbolo de la moneda\r
