import{a as e,n as t}from"./chunk-BneVvdWh.js";import{O as n,a as r,i,o as a}from"./iframe-BoT0I_bJ.js";var o,s,c,l,u,d=t((()=>{o=`_listControl_bziyc_1`,s=`_item_bziyc_11`,c=`_label_bziyc_31`,l=`_description_bziyc_45`,u={listControl:o,item:s,"item--disabled":`_item--disabled_bziyc_23`,"item--selected":`_item--selected_bziyc_26`,label:c,description:l}})),f,p,m=t((()=>{n(),a(),d(),f=i(),p=({items:e,onSelect:t,multiSelect:n=!1,className:i,...a})=>(0,f.jsx)(`ul`,{role:`listbox`,"aria-multiselectable":n,className:r(u.listControl,i),...a,children:e.map(e=>(0,f.jsxs)(`li`,{role:`option`,"aria-selected":e.selected??!1,"aria-disabled":e.disabled,className:r(u.item,e.selected&&u[`item--selected`],e.disabled&&u[`item--disabled`]),onClick:()=>!e.disabled&&t?.(e.key),onKeyDown:n=>{(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),e.disabled||t?.(e.key))},children:[(0,f.jsx)(`span`,{className:u.label,children:e.label}),e.description&&(0,f.jsx)(`span`,{className:u.description,children:e.description})]},e.key))}),p.__docgenInfo={description:`ListControl component that displays a selectable list of items.\r
\r
