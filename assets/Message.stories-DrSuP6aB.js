import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as g}from"./index-D4lIrffr.js";import{c as $}from"./index-_oZgBBUR.js";import{b as G}from"./index-kIl7L5_b.js";const J="_message_1fl9s_1",K="_messageContent_1fl9s_23",Q="_messageTitle_1fl9s_34",U="_messageIcon_1fl9s_40",X="_messageBody_1fl9s_52",Y="_messageText_1fl9s_63",Z="_closable_1fl9s_118",s={message:J,messageContent:K,messageTitle:Q,messageIcon:U,messageBody:X,messageText:Y,"message-success":"_message-success_1fl9s_82","message-info":"_message-info_1fl9s_91","message-warning":"_message-warning_1fl9s_100","message-danger":"_message-danger_1fl9s_109",closable:Z,"message-enter":"_message-enter_1fl9s_122","message-enter-active":"_message-enter-active_1fl9s_127","message-exit":"_message-exit_1fl9s_133","message-exit-active":"_message-exit-active_1fl9s_138"},ee={success:"check-circle",info:"info-circle",warning:"exclamation-triangle",danger:"times-circle"},se=t=>t==="warning"||t==="danger"?"alert":"status",a=({type:t="info",title:m,children:V,className:D,style:W,closable:u=!1,onClose:r,role:B,"data-testid":R="message",...L})=>{const[k,z]=g.useState(!0),p=B||se(t),H=p==="alert"?"assertive":"polite",O=g.useCallback(F=>{F.preventDefault(),z(!1),r==null||r()},[r]);if(!k)return null;const P=$(s.message,s[`message-${t}`],{[s.closable]:u},D);return e.jsxs("div",{className:P,style:W,role:p,"aria-live":H,"data-testid":R,...L,children:[e.jsxs("div",{className:s.messageContent,children:[e.jsx("div",{className:s.messageIcon,children:e.jsx(G,{name:ee[t],"aria-hidden":"true"})}),e.jsxs("div",{className:s.messageText,children:[m&&e.jsx("div",{className:s.messageTitle,"data-testid":"message-title",children:m}),e.jsx("div",{className:s.messageBody,children:V})]})]}),u&&e.jsx("button",{type:"button",className:s.closeButton,onClick:O,"aria-label":"Cerrar mensaje","data-testid":"message-close-button",children:e.jsx("span",{"aria-hidden":"true",children:"×"})})]})};a.__docgenInfo={description:"",methods:[],displayName:"Message",props:{type:{required:!1,tsType:{name:"union",raw:"'success' | 'info' | 'warning' | 'danger'",elements:[{name:"literal",value:"'success'"},{name:"literal",value:"'info'"},{name:"literal",value:"'warning'"},{name:"literal",value:"'danger'"}]},description:`Tipo de mensaje a mostrar 
...
}`,...(A=(S=d.parameters)==null?void 0:S.docs)==null?void 0:A.source}}};const oe=["Default","WithTitle","Closable","Types","WithCustomContent","WithoutTitle"];export{o as Closable,n as Default,l as Types,c as WithCustomContent,i as WithTitle,d as WithoutTitle,oe as __namedExportsOrder,ie as default};
