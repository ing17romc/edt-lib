import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{R as I}from"./index-D4lIrffr.js";const W="_typographyContainer_1ejnq_1",D="_title_1ejnq_9",P="_subtitle_1ejnq_16",R="_headingExample_1ejnq_23",L="_h1_1ejnq_26",V="_h2_1ejnq_32",F="_h3_1ejnq_38",G="_h4_1ejnq_44",O="_h5_1ejnq_50",U="_h6_1ejnq_56",J="_paragraphExample_1ejnq_63",K="_paragraph_1ejnq_63",Q="_bold_1ejnq_95",X="_codeExample_1ejnq_108",Y="_divider_1ejnq_119",e={typographyContainer:W,title:D,subtitle:P,headingExample:R,h1:L,h2:V,h3:F,h4:G,h5:O,h6:U,paragraphExample:J,paragraph:K,"size-8":"_size-8_1ejnq_71","size-10":"_size-10_1ejnq_74","size-12":"_size-12_1ejnq_77","size-14":"_size-14_1ejnq_80","size-16":"_size-16_1ejnq_83","size-18":"_size-18_1ejnq_86","size-20":"_size-20_1ejnq_89","size-22":"_size-22_1ejnq_92",bold:Q,"line-height-simple":"_line-height-simple_1ejnq_98","line-height-doble":"_line-height-doble_1ejnq_101","line-height-triple":"_line-height-triple_1ejnq_104",codeExample:X,divider:Y},v=(o={})=>{const n="It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.",w=s=>{const r=`h${s}`;return a.jsxs("div",{className:e.headingExample,children:[I.createElement(r,{className:e[`h${s}`],"data-testid":`heading-${s}`},`<h${s}>Heading ${s}</h${s}>`),a.jsx("code",{className:e.codeExample,children:`<h${s}>Heading ${s}</h${s}>`}),a.jsx("hr",{className:e.divider})]},`heading-${s}`)},M=(s,r="")=>a.jsxs("div",{className:e.paragraphExample,children:[a.jsx("p",{className:`${e.paragraph} ${e[`size-${s}`]}`,children:r||`This is a sample text with size ${s}px`}),a.jsx("code",{className:e.codeExample,children:`<p class="${e.paragraph} ${e[`size-${s}`]}">${r||`Text with size ${s}px`}</p>`}),a.jsx("hr",{className:e.divider})]},`paragraph-${s}`),k=s=>{const r={simple:"1.5",doble:"2",triple:"3"};return a.jsxs("div",{className:e.lineHeightExample,children:[a.jsx("p",{className:`${e.paragraph} ${e["size-22"]} ${e[`line-height-${s}`]}`,style:{"--line-height":r[s]},children:n}),a.jsx("code",{className:e.codeExample,children:`<p class="${e.paragraph} ${e["size-22"]} ${e[`line-height-${s}`]}" style="--line-height: ${r[s]};">${n}</p>`}),a.jsx("hr",{className:e.divider})]},`line-height-${s}`)},{showCodeExamples:H=!0,className:B=""}=o||{},A=[e.typographyContainer,B].filter(Boolean).join(" ");return a.jsxs("div",{className:A,"data-testid":"typography-container",children:[a.jsx("h1",{className:e.title,children:"Headings"}),a.jsx("hr",{className:e.divider}),[1,2,3,4,5,6].map(w),a.jsx("h1",{className:e.title,children:"Paragraphs"}),a.jsx("hr",{className:e.divider}),["22","20","18","16","14","12","10","8"].map(s=>M(s,s==="22"?n:"")),a.jsxs("div",{className:e.paragraphExample,children:[a.jsx("p",{className:`${e.paragraph} ${e["size-22"]} ${e.bold}`,children:n}),H&&a.jsx("code",{className:e.codeExample,"data-testid":"code-example",children:`<p class="${e.paragraph} ${e["size-22"]} ${e.bold}">${n}</p>`}),a.jsx("hr",{className:e.divider})]}),a.jsx("h2",{className:e.subtitle,children:"Line Height Examples"}),a.jsx("hr",{className:e.divider}),["simple","doble","triple"].map(k)]})};v.__docgenInfo={description:`Typography
...
Incluye encabezados (h1-h6), párrafos con diferentes tamaños y ejemplos de interlineado.`,...(g=(h=i.parameters)==null?void 0:h.docs)==null?void 0:g.description}}};var u,x,y,_,j;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
...
Muestra los estilos tipográficos sin los ejemplos de código, útil para una vista más limpia.`,...(j=(_=t.parameters)==null?void 0:_.docs)==null?void 0:j.description}}};var f,b,E,$,C;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
...
con un encabezado, contenido y pie de página.`,...(T=(S=d.parameters)==null?void 0:S.docs)==null?void 0:T.description}}};const oe=["Default","WithoutCodeExamples","WithCustomClass","InContext"];export{i as Default,d as InContext,p as WithCustomClass,t as WithoutCodeExamples,oe as __namedExportsOrder,se as default};
