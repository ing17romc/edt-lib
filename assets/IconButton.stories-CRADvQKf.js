import{n as e}from"./chunk-BneVvdWh.js";import{Ht as t,J as n,Q as r,Z as i,_t as a,bt as o,q as s,vt as c,yt as l}from"./iframe-BrtTKpdh.js";var u,d,f,p,m,h,g=e((()=>{o(),u={tags:[`autodocs`],argTypes:{icon:{control:{type:`text`},description:`Name of the icon to display (Material Symbols identifier).`,table:{type:{summary:`string`}}},size:{control:`select`,options:Object.values(c),description:`Size of the icon button.`,table:{type:{summary:Object.values(c).join(` | `)},defaultValue:{summary:c.MEDIUM}}},variant:{control:{type:`select`},options:[`primary`,`secondary`,`tertiary`,`danger`,`success`,`warning`],description:`Visual color variant of the button.`,table:{type:{summary:`primary | secondary | tertiary | danger | success | warning`},defaultValue:{summary:`"primary"`}}},disabled:{control:{type:`boolean`},description:`When true, the button is non-interactive and visually muted.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},loading:{control:{type:`boolean`},description:`When true, shows a loading spinner instead of the icon.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},fullWidth:{control:{type:`boolean`},description:`When true, the button expands to fill the full width of its container.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},iconVariant:{control:{type:`select`},options:[`solid`,`outline`,`dual`],description:`Rendering style of the icon — solid fill, outline, or dual-tone.`,table:{type:{summary:`solid | outline | dual`},defaultValue:{summary:`"outline"`}}},iconColor:{control:{type:`color`},description:`Custom color override for the icon.`,table:{type:{summary:`string`}}},onClick:{action:`clicked`,description:`Callback fired when the button is clicked.`,table:{type:{summary:`() => void`}}}},args:{icon:`home`,"aria-label":`Example button`,size:c.MEDIUM,variant:`primary`,disabled:!1,loading:!1,fullWidth:!1,iconVariant:`outline`}},d={docs:{description:{component:`A compact button that renders an icon as its primary content. Supports all button variants, sizes, loading state, and a custom icon color override.`}}},f=[{size:c.SMALL,label:`Small`},{size:c.MEDIUM,label:`Medium`},{size:c.LARGE,label:`Large`}],p=[{variant:l.PRIMARY,label:`Primary`},{variant:l.SECONDARY,label:`Secondary`},{variant:l.TERTIARY,label:`Tertiary`},{variant:l.DANGER,label:`Danger`},{variant:l.SUCCESS,label:`Success`},{variant:l.WARNING,label:`Warning`}],m={display:`flex`,gap:`16px`,alignItems:`center`,flexWrap:`wrap`,marginBottom:`16px`},h={display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`,minWidth:`80px`}})),_,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{t(),r(),n(),g(),o(),_=a(),{within:v,expect:y}=__STORYBOOK_MODULE_TEST__,b={title:`Components/IconButton`,...u,component:s,parameters:d},x={args:{"aria-label":`Home button`},play:async({canvasElement:e})=>{let t=v(e).getByRole(`button`);await y(t).toHaveClass(`iconButton--medium`),await y(t).toHaveClass(`iconButton--primary`)}},S={render:()=>(0,_.jsx)(`div`,{style:m,children:f.map(({size:e,label:t})=>(0,_.jsxs)(`div`,{style:h,children:[(0,_.jsx)(s,{icon:`home`,size:e,"aria-label":`${t} button`}),(0,_.jsx)(`span`,{children:t})]},e))}),play:async({canvasElement:e})=>{let t=v(e).getAllByRole(`button`);await y(t[0]).toHaveClass(`iconButton--small`),await y(t[1]).toHaveClass(`iconButton--medium`),await y(t[2]).toHaveClass(`iconButton--large`)},parameters:{docs:{description:{story:`Shows the different sizes available for the IconButton component.`}}}},C={render:()=>(0,_.jsx)(`div`,{style:m,children:p.map(({variant:e,label:t})=>(0,_.jsxs)(`div`,{style:h,children:[(0,_.jsx)(s,{icon:`star`,variant:e,"aria-label":`${t} button`}),(0,_.jsx)(`span`,{children:t})]},e))}),play:async({canvasElement:e})=>{let t=v(e).getAllByRole(`button`);await y(t[0]).toHaveClass(`iconButton--primary`),await y(t[1]).toHaveClass(`iconButton--secondary`),await y(t[2]).toHaveClass(`iconButton--tertiary`),await y(t[3]).toHaveClass(`iconButton--danger`),await y(t[4]).toHaveClass(`iconButton--success`),await y(t[5]).toHaveClass(`iconButton--warning`)},parameters:{docs:{description:{story:`Shows the different style variants available for the IconButton component.`}}}},w={render:()=>(0,_.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,alignItems:`center`},children:[(0,_.jsx)(s,{icon:`check`,"aria-label":`Normal`}),(0,_.jsx)(s,{icon:`check`,disabled:!0,"aria-label":`Disabled`}),(0,_.jsx)(s,{icon:`check`,loading:!0,"aria-label":`Loading`})]}),play:async({canvasElement:e})=>{let t=v(e).getAllByRole(`button`);await y(t[0]).not.toHaveClass(`iconButton--loading`),await y(t[1]).toHaveAttribute(`aria-disabled`,`true`),await y(t[2]).toHaveClass(`iconButton--loading`)}},T={render:()=>(0,_.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,alignItems:`center`},children:[(0,_.jsx)(s,{icon:`home`,"aria-label":`Home`}),(0,_.jsx)(s,{icon:`settings`,variant:l.SECONDARY,"aria-label":`Settings`}),(0,_.jsx)(s,{icon:`search`,variant:l.TERTIARY,"aria-label":`Search`}),(0,_.jsx)(s,{icon:`heart`,variant:l.DANGER,"aria-label":`Favorite`}),(0,_.jsx)(s,{icon:`download`,variant:l.SUCCESS,"aria-label":`Download`}),(0,_.jsx)(s,{icon:`bell`,variant:l.WARNING,"aria-label":`Notifications`})]})},E={args:{icon:`favorite`,iconColor:`#ff4081`,"aria-label":`Pink favorite`}},D={render:()=>(0,_.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,alignItems:`center`},children:[(0,_.jsx)(s,{icon:`star`,iconVariant:i.OUTLINE,"aria-label":`Outline`}),(0,_.jsx)(s,{icon:`star`,iconVariant:i.SOLID,"aria-label":`Solid`}),(0,_.jsx)(s,{icon:`star`,iconVariant:i.DUAL,"aria-label":`Dual`})]})},O={render:()=>(0,_.jsxs)(`div`,{style:{width:`300px`},children:[(0,_.jsx)(s,{icon:`add`,fullWidth:!0,"aria-label":`Add`,style:{marginBottom:`8px`}}),(0,_.jsx)(s,{icon:`delete`,variant:l.DANGER,fullWidth:!0,"aria-label":`Delete`})]})},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
