import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u,R as $}from"./index-D4lIrffr.js";import{c as G}from"./index-_oZgBBUR.js";import{b as g}from"./index-kIl7L5_b.js";const J="_message_100dz_1",K="_messageContent_100dz_12",Q="_messageIcon_100dz_19",X="_messageBody_100dz_29",Y="_messageBodyTitle_100dz_33",Z="_messageBodyText_100dz_38",ee="_messageTitle_100dz_43",se="_messageText_100dz_49",ae="_messageCloseButton_100dz_55",ne="_closable_100dz_111",a={message:J,messageContent:K,messageIcon:Q,messageBody:X,messageBodyTitle:Y,messageBodyText:Z,messageTitle:ee,messageText:se,messageCloseButton:ae,"message-success":"_message-success_100dz_79","message-info":"_message-info_100dz_87","message-warning":"_message-warning_100dz_95","message-danger":"_message-danger_100dz_103",closable:ne,"message-enter":"_message-enter_100dz_117","message-enter-active":"_message-enter-active_100dz_121","message-exit":"_message-exit_100dz_126","message-exit-active":"_message-exit-active_100dz_130"},n=({type:s="info",title:l,children:c,className:q,style:D,closable:m=!1,onClose:d,role:H,"data-testid":P="message",...V})=>{const[W,A]=u.useState(!0),p=H||(s==="warning"||s==="danger"?"alert":"status"),L={success:"check-circle",info:"info-circle",warning:"exclamation-triangle",danger:"times-circle"},O=u.useCallback(U=>{U.preventDefault(),A(!1),d&&d()},[d]);if(!W)return null;const F=G(a.message,{[a[`message-${s}`]]:s,[a.closable]:m},q);return e.jsx("div",{className:F,style:D,role:p,"aria-live":p==="alert"?"assertive":"polite","data-testid":P,...V,children:e.jsxs("div",{className:a.messageContent,children:[e.jsx("div",{className:a.messageIcon,children:e.jsx(g,{name:L[s],"aria-hidden":"true"})}),e.jsxs("div",{className:a.messageBody,children:[l&&e.jsx("strong",{className:a.messageTitle,"data-testid":"message-title",children:l}),e.jsx("div",{className:a.messageText,"data-testid":"message-content",children:c})]}),m&&e.jsx("button",{type:"button",className:a.closeButton,onClick:O,"aria-label":"Cerrar mensaje","data-testid":"message-close-button",children:e.jsx(g,{name:"times","aria-hidden":"true"})})]})})};n.__docgenInfo={description:`Componente Message
...
Muestra los diferentes estilos de mensaje según su tipo.`,...(T=(M=t.parameters)==null?void 0:M.docs)==null?void 0:T.description}}};var z,C,E,B,N;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'grid',
    gap: '1.5rem',
    maxWidth: '800px',
...
}`,...(E=(C=r.parameters)==null?void 0:C.docs)==null?void 0:E.source},description:{story:`Mensaje con contenido personalizado

Ejemplos de mensajes con contenido HTML personalizado y estilos adicionales.`,...(N=(B=r.parameters)==null?void 0:B.docs)==null?void 0:N.description}}};var S,I,w,R,k;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    type: 'info',
