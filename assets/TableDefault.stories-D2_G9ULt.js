...
\r
Componente de tabla que muestra una tabla grande con múltiples columnas repetidas.\r
Útil para mostrar datos en formato de tabla expandida.\r
\r
@param {TableDefaultProps} props - Propiedades del componente, incluyendo el arreglo de datos a mostrar.\r
@returns {JSX.Element} Tabla expandida con datos repetidos por fila.`,methods:[],displayName:`TableDefault`,props:{dataTable:{required:!0,tsType:{name:`Array`,elements:[{name:`TableRowData`}],raw:`TableRowData[]`},description:``}}};var o=[{name:`John Doe`,userName:`johndoe`,status:!0},{name:`Jane Smith`,userName:`janesmith`,status:!1},{name:`Robert Johnson`,userName:`rjohnson`,status:!0},{name:`Emily Davis`,userName:`edavis`,status:1},{name:`Michael Wilson`,userName:`mwilson`,status:0}],s={title:`Examples/Tables/TableDefault`,component:a,parameters:{layout:`centered`,docs:{description:{component:`Tabla predeterminada que muestra múltiples columnas con información repetida. Útil para mostrar grandes conjuntos de datos en un formato tabular amplio.`}}},tags:[`autodocs`]},c={args:{dataTable:o},parameters:{docs:{description:{story:`Tabla predeterminada con múltiples columnas que repiten la información.`}}}},l={args:{dataTable:[]},parameters:{docs:{description:{story:`Tabla sin datos. Muestra solo los encabezados de las columnas.`}}}},u={args:{dataTable:[o[0]]},parameters:{docs:{description:{story:`Tabla con una sola fila de datos.`}}}},d={args:{dataTable:[...o,{name:`Sarah Williams`,userName:`swilliams`,status:!0},{name:`David Brown`,userName:`dbrown`,status:!1}]},parameters:{docs:{description:{story:`Tabla con múltiples filas para probar el desplazamiento horizontal.`}}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
