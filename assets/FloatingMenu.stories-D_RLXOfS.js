import{a as e,n as t}from"./chunk-BneVvdWh.js";import{O as n,a as r,i,o as a}from"./iframe-BoT0I_bJ.js";var o,s,c,l,u,d,f,p=t((()=>{o=`_floatingMenu_13ntm_1`,s=`_trigger_13ntm_6`,c=`_dropdown_13ntm_12`,l=`_item_13ntm_45`,u=`_icon_13ntm_69`,d=`_divider_13ntm_75`,f={floatingMenu:o,trigger:s,dropdown:c,"dropdown--bottom-start":`_dropdown--bottom-start_13ntm_24`,"dropdown--bottom-end":`_dropdown--bottom-end_13ntm_28`,"dropdown--top-start":`_dropdown--top-start_13ntm_32`,"dropdown--top-end":`_dropdown--top-end_13ntm_38`,item:l,"item--disabled":`_item--disabled_13ntm_64`,icon:u,divider:d}})),m,h,g,_=t((()=>{m=e(n(),1),a(),p(),h=i(),g=({trigger:e,items:t,placement:n=`bottom-start`,onSelect:i,disabled:a=!1,className:o,...s})=>{let[c,l]=(0,m.useState)(!1),u=(0,m.useRef)(null);(0,m.useEffect)(()=>{let e=e=>{u.current&&!u.current.contains(e.target)&&l(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let d=e=>{i?.(e),l(!1)},p=()=>{a||l(e=>!e)},g=(0,m.isValidElement)(e)?(0,m.cloneElement)(e,{onClick:p,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),p())}}):e;return(0,h.jsxs)(`div`,{ref:u,className:r(f.floatingMenu,o),...s,children:[(0,h.jsx)(`div`,{className:f.trigger,children:g}),c&&(0,h.jsx)(`ul`,{role:`menu`,className:r(f.dropdown,f[`dropdown--${n}`]),children:t.map(e=>e.divider?(0,h.jsx)(`li`,{role:`separator`,className:f.divider},e.key):(0,h.jsx)(`li`,{role:`none`,children:(0,h.jsxs)(`button`,{role:`menuitem`,type:`button`,disabled:e.disabled,className:r(f.item,e.disabled&&f[`item--disabled`]),onClick:()=>!e.disabled&&d(e.key),children:[e.icon&&(0,h.jsx)(`span`,{className:f.icon,children:e.icon}),(0,h.jsx)(`span`,{children:e.label})]})},e.key))})]})},g.__docgenInfo={description:`FloatingMenu component that displays a dropdown menu over a trigger element.\r
\r
