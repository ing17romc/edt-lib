import{n as e}from"./chunk-BneVvdWh.js";import{O as t,i as n}from"./iframe-BoT0I_bJ.js";import{n as r,t as i}from"./NavBar-DXiPTWxR.js";var a,o,s,c=e((()=>{t(),a=n(),o=()=>(0,a.jsx)(`div`,{style:{width:`32px`,height:`32px`,backgroundColor:`var(--color-primary)`,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`white`,fontWeight:`bold`,borderRadius:`4px`},children:`L`}),s=()=>(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(`a`,{href:`#inicio`,style:{textDecoration:`none`,color:`inherit`},children:`Inicio`}),(0,a.jsx)(`a`,{href:`#acerca`,style:{textDecoration:`none`,color:`inherit`},children:`Acerca de`}),(0,a.jsx)(`a`,{href:`#contacto`,style:{textDecoration:`none`,color:`inherit`},children:`Contacto`})]}),o.__docgenInfo={description:``,methods:[],displayName:`MockLogo`},s.__docgenInfo={description:``,methods:[],displayName:`MockNav`}})),l,u,d,f,p,m,h,g,_;e((()=>{t(),r(),c(),l=n(),{within:u,expect:d}=__STORYBOOK_MODULE_TEST__,f={title:`Layout/NavBar`,component:i,tags:[`autodocs`],argTypes:{title:{control:`text`,description:`Application or page title displayed in the navigation bar.`,table:{type:{summary:`string`}}},className:{control:`text`,description:`Additional CSS class name for the root element.`,table:{type:{summary:`string`}}}},parameters:{docs:{description:{component:`A top navigation bar that combines a logo slot, an optional title, and navigation link children. Sticks to the top of the page and spans full width.`}}}},p={render:e=>(0,l.jsx)(i,{...e,logo:(0,l.jsx)(o,{}),title:`My App`,children:(0,l.jsx)(s,{})}),args:{},play:async({canvasElement:e})=>{let t=u(e);await d(t.getByText(`My App`)).toBeInTheDocument(),await d(t.getByText(`Inicio`)).toBeInTheDocument(),await d(t.getByText(`Acerca de`)).toBeInTheDocument(),await d(t.getByText(`Contacto`)).toBeInTheDocument()}},m={render:e=>(0,l.jsx)(i,{...e,title:`My App`}),args:{}},h={render:e=>(0,l.jsx)(i,{...e,logo:(0,l.jsx)(o,{})}),args:{}},g={render:e=>(0,l.jsx)(i,{...e}),args:{}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
