import{t as e}from"./iframe-BwpCWMiM.js";import{t}from"./jsx-runtime-BsbbwSUz.js";import{t as n}from"./types-BTwUNDvM.js";import{n as r,t as i}from"./Icon-CRq4DNId.js";e();var a={display:`flex`,gap:`16px`,alignItems:`center`,flexWrap:`wrap`,marginBottom:`16px`},o={display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`,minWidth:`80px`};n.SMALL,n.MEDIUM,n.LARGE,r.OUTLINE,r.SOLID,r.DUAL;var s=t(),c={title:`Components/Icon`,component:i,tags:[`autodocs`],argTypes:{name:{control:`text`,description:`Material Icons name (e.g. "home", "star", "settings"). See https://fonts.google.com/icons for the full list.`,table:{type:{summary:`string`}}},size:{control:`select`,options:Object.values(n),description:`Size of the icon.`,table:{type:{summary:Object.values(n).join(` | `)},defaultValue:{summary:n.MEDIUM}}},variant:{control:`select`,options:Object.values(r),description:`Icon style variant: outline, solid, or dual-tone.`,table:{type:{summary:Object.values(r).join(` | `)},defaultValue:{summary:r.OUTLINE}}},color:{control:`color`,description:`Primary color of the icon. Has no effect when inheritColor is true.`,table:{type:{summary:`string`}}},secondaryColor:{control:`color`,description:`Secondary color used only for the dual-tone variant.`,table:{type:{summary:`string`}}},inheritColor:{control:{type:`boolean`},description:`When true, the icon inherits its color from the parent element.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}}},parameters:{docs:{description:{component:`Renders a Material Icons glyph with support for multiple sizes, style variants (outline, solid, dual-tone) and custom or inherited colors.`}}},args:{name:`home`,size:n.MEDIUM,variant:r.OUTLINE}},l={args:{name:`home`}},u={render:()=>(0,s.jsx)(`div`,{style:a,children:Object.values(n).map(e=>(0,s.jsxs)(`div`,{style:o,children:[(0,s.jsx)(i,{name:`home`,size:e}),(0,s.jsx)(`span`,{children:e})]},e))}),parameters:{docs:{description:{story:`Shows the different sizes available for the Icon component.`}}}},d={render:()=>(0,s.jsxs)(`div`,{style:a,children:[(0,s.jsxs)(`div`,{style:o,children:[(0,s.jsx)(i,{name:`home`,variant:r.OUTLINE}),(0,s.jsx)(`span`,{children:`Outline`})]}),(0,s.jsxs)(`div`,{style:o,children:[(0,s.jsx)(i,{name:`home`,variant:r.SOLID,color:`#007bff`}),(0,s.jsx)(`span`,{children:`Solid`})]}),(0,s.jsxs)(`div`,{style:o,children:[(0,s.jsx)(i,{name:`home`,variant:r.DUAL,color:`#ff5722`,secondaryColor:`#4caf50`}),(0,s.jsx)(`span`,{children:`Dual`})]})]}),parameters:{docs:{description:{story:`Shows the different style variants available for the Icon component.`}}}},f={args:{name:`star`,color:`#ff5722`},parameters:{docs:{description:{story:`Example of an icon with a custom color.`}}}},p={render:()=>(0,s.jsxs)(`div`,{style:{color:`purple`},children:[(0,s.jsx)(`p`,{children:`This text is purple, and the icon inherits the color:`}),(0,s.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,alignItems:`center`,marginTop:`8px`},children:[(0,s.jsx)(i,{name:`check`,inheritColor:!0,size:n.LARGE}),(0,s.jsx)(i,{name:`star`,inheritColor:!0,size:n.LARGE}),(0,s.jsx)(i,{name:`heart`,inheritColor:!0,size:n.LARGE})]})]}),parameters:{docs:{description:{story:`Example of icons that inherit the color from the parent element.`}}}},m={render:()=>(0,s.jsxs)(`div`,{style:a,children:[(0,s.jsxs)(`div`,{style:o,children:[(0,s.jsx)(i,{name:`home`,disabled:!0}),(0,s.jsx)(`span`,{children:`Disabled`})]}),(0,s.jsxs)(`div`,{style:o,children:[(0,s.jsx)(i,{name:`home`}),(0,s.jsx)(`span`,{children:`Enabled`})]})]}),parameters:{docs:{description:{story:`Shows the disabled state of the icon.`}}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'home'
  }
