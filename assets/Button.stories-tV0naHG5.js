import{n as e}from"./chunk-BneVvdWh.js";import{_t as t,bt as n,mt as r,pt as i,vt as a,yt as o}from"./iframe-BrtTKpdh.js";var s,c,l,u,d,f,p=e((()=>{n(),s={children:`Button`,disabled:!1,fullWidth:!1},c={children:{control:`text`,description:`Button label or React content displayed inside the button.`,table:{type:{summary:`ReactNode`}}},variant:{control:`select`,options:Object.values(o),description:`Visual variant of the button.`,table:{type:{summary:Object.values(o).join(` | `)},defaultValue:{summary:o.PRIMARY}}},size:{control:`select`,options:Object.values(a),description:`Size of the button.`,table:{type:{summary:Object.values(a).join(` | `)},defaultValue:{summary:a.MEDIUM}}},disabled:{control:`boolean`,description:`When true, the button is non-interactive and visually muted.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},fullWidth:{control:`boolean`,description:`When true, the button stretches to fill its container width.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},loading:{control:`boolean`,description:`When true, shows a loading indicator and disables interaction.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},type:{control:`select`,options:[`button`,`submit`,`reset`],description:`HTML button type attribute.`,table:{type:{summary:`button | submit | reset`},defaultValue:{summary:`button`}}},onClick:{action:`clicked`,description:`Callback fired when the button is clicked.`,table:{type:{summary:`(event: MouseEvent) => void`}}}},l=Object.values(o).map(e=>({variant:e,label:e.charAt(0).toUpperCase()+e.slice(1)})),u=Object.values(a).map(e=>({size:e,label:e.charAt(0).toUpperCase()+e.slice(1)})),d={docs:{description:{component:`A multi-purpose button component with support for multiple visual variants, sizes, loading state, and full-width layout. Built on top of the native HTML button element.`}}},f={tags:[`autodocs`],parameters:d,argTypes:c,args:s}})),m,h,g,_,v,y,b,x,S,C;e((()=>{r(),p(),n(),m=t(),{within:h,expect:g}=__STORYBOOK_MODULE_TEST__,_={title:`Components/Button`,...f,component:i,tags:[`autodocs`]},v={args:{children:`Button`,variant:o.PRIMARY,size:a.MEDIUM},play:async({canvasElement:e})=>{let t=h(e).getByRole(`button`,{name:/button/i});await g(t).toBeInTheDocument(),await g(t).toHaveClass(`button--primary`),await g(t).toHaveClass(`button--medium`),await g(t).toHaveAttribute(`type`,`button`),await g(t).not.toBeDisabled()}},y={render:()=>(0,m.jsx)(`div`,{style:{display:`flex`,gap:`1rem`,flexWrap:`wrap`,alignItems:`center`},children:l.map(({variant:e,label:t})=>(0,m.jsxs)(`div`,{style:{marginBottom:`1rem`},children:[(0,m.jsx)(`div`,{style:{marginBottom:`0.5rem`,fontSize:`0.875rem`,color:`#666`},children:t}),(0,m.jsxs)(i,{variant:e,children:[t,` Button`]})]},e))}),play:async({canvasElement:e})=>{let t=h(e);for(let{variant:e,label:n}of l)await g(t.getByRole(`button`,{name:`${n} Button`})).toHaveClass(`button--${e}`)},parameters:{docs:{source:{code:null}}}},b={render:()=>(0,m.jsx)(`div`,{style:{display:`flex`,gap:`1.5rem`,alignItems:`flex-end`},children:u.map(({size:e,label:t})=>(0,m.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,m.jsx)(`div`,{style:{marginBottom:`0.5rem`,fontSize:`0.875rem`,color:`#666`},children:t}),(0,m.jsxs)(i,{size:e,children:[e,` Button`]})]},e))}),play:async({canvasElement:e})=>{let t=h(e);for(let{size:e}of u)await g(t.getByRole(`button`,{name:`${e} Button`})).toHaveClass(`button--${e}`)},parameters:{docs:{source:{code:null}}}},x={render:()=>(0,m.jsxs)(`div`,{style:{display:`flex`,gap:`1.5rem`,flexWrap:`wrap`},children:[(0,m.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`0.5rem`},children:[(0,m.jsx)(`div`,{style:{fontSize:`0.875rem`,color:`#666`},children:`Disabled`}),(0,m.jsx)(i,{disabled:!0,children:`Disabled Button`})]}),(0,m.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`0.5rem`,width:`100%`,maxWidth:`300px`},children:[(0,m.jsx)(`div`,{style:{fontSize:`0.875rem`,color:`#666`},children:`Full Width`}),(0,m.jsx)(i,{fullWidth:!0,children:`Full Width Button`})]})]}),play:async({canvasElement:e})=>{let t=h(e);await g(t.getByRole(`button`,{name:/disabled button/i})).toBeDisabled(),await g(t.getByRole(`button`,{name:/full width button/i})).toHaveClass(`button--fullWidth`)},parameters:{docs:{source:{code:null}}}},S={render:()=>(0,m.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`1.5rem`},children:l.map(({variant:e,label:t})=>(0,m.jsxs)(`div`,{children:[(0,m.jsxs)(`div`,{style:{marginBottom:`0.75rem`,fontSize:`0.875rem`,color:`#666`,fontWeight:`500`},children:[t,` Variant`]}),(0,m.jsx)(`div`,{style:{display:`flex`,gap:`1rem`,alignItems:`center`},children:u.map(({size:t,label:n})=>(0,m.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`0.5rem`},children:[(0,m.jsx)(`div`,{style:{fontSize:`0.75rem`,color:`#888`},children:n}),(0,m.jsx)(i,{variant:e,size:t,children:n})]},`${e}-${t}`))})]},e))}),parameters:{docs:{source:{code:null}}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    children: 'Button',
