...
@default false`,defaultValue:{value:`false`,computed:!1}},disabled:{required:!1,tsType:{name:`boolean`},description:`Si es true, muestra el botón en estado de deshabilitado\r
@default false`,defaultValue:{value:`false`,computed:!1}},loading:{required:!1,tsType:{name:`boolean`},description:`Si es true, muestra un indicador de carga\r
@default false`,defaultValue:{value:`false`,computed:!1}},color:{required:!1,tsType:{name:`union`,raw:`'primary' | 'secondary' | 'error' | 'success' | 'warning' | 'inherit'`,elements:[{name:`literal`,value:`'primary'`},{name:`literal`,value:`'secondary'`},{name:`literal`,value:`'error'`},{name:`literal`,value:`'success'`},{name:`literal`,value:`'warning'`},{name:`literal`,value:`'inherit'`}]},description:`Color del texto del botón\r
@default 'primary'`,defaultValue:{value:`'primary'`,computed:!1}},underline:{required:!1,tsType:{name:`union`,raw:`'none' | 'hover' | 'always'`,elements:[{name:`literal`,value:`'none'`},{name:`literal`,value:`'hover'`},{name:`literal`,value:`'always'`}]},description:`Si es true, añade un subrayado al texto\r
