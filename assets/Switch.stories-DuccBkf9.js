...
@component`,methods:[],displayName:`Switch`,props:{label:{required:!1,tsType:{name:`string`},description:`Etiqueta del switch`},checked:{required:!1,tsType:{name:`boolean`},description:`Si el switch está activado\r
@default false`,defaultValue:{value:`false`,computed:!1}},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(checked: boolean) => void`,signature:{arguments:[{type:{name:`boolean`},name:`checked`}],return:{name:`void`}}},description:`Callback al cambiar el estado`},size:{required:!1,tsType:{name:`ComponentSize`},description:`Tamaño del switch\r
@default 'medium'`,defaultValue:{value:`ComponentSize.MEDIUM`,computed:!0}},disabled:{required:!1,tsType:{name:`boolean`},description:`Si el switch está deshabilitado\r
