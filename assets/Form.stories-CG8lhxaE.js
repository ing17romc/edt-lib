...
@returns {JSX.Element} Formulario interactivo de datos personales`,methods:[],displayName:"Form"};const ee={title:"Examples/Form",component:o,tags:["autodocs","examples"],parameters:{componentSubtitle:"Formulario de datos personales",docs:{description:{component:`
...
}`,...(g=(u=d.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};const ae=["Default","Disabled"];export{r as Default,d as Disabled,ae as __namedExportsOrder,ee as default};
