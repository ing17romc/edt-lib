import{a as e,n as t}from"./chunk-BneVvdWh.js";import{S as n}from"./iframe-BoFEwu8W.js";import{t as r}from"./jsx-runtime-Bn1Ys6_W.js";import{n as i,t as a}from"./classNames-Bj-wXTiJ.js";var o,s,c,l,u,d=t((()=>{o=`_tabs_12jes_1`,s=`_tabList_12jes_7`,c=`_tab_12jes_1`,l=`_panel_12jes_42`,u={tabs:o,tabList:s,tab:c,"tab--active":`_tab--active_12jes_31`,"tab--disabled":`_tab--disabled_12jes_36`,panel:l}})),f,p,m,h=t((()=>{f=e(n(),1),i(),d(),p=r(),m=({tabs:e,activeKey:t,defaultActiveKey:n,onChange:r,className:i,...o})=>{let[s,c]=(0,f.useState)(n??e[0]?.key??``),l=t??s,d=e=>{t||c(e),r?.(e)},m=e.find(e=>e.key===l);return(0,p.jsxs)(`div`,{className:a(u.tabs,i),...o,children:[(0,p.jsx)(`div`,{role:`tablist`,className:u.tabList,children:e.map(e=>(0,p.jsx)(`button`,{role:`tab`,type:`button`,"aria-selected":e.key===l,"aria-controls":`panel-${e.key}`,id:`tab-${e.key}`,disabled:e.disabled,className:a(u.tab,e.key===l&&u[`tab--active`],e.disabled&&u[`tab--disabled`]),onClick:()=>!e.disabled&&d(e.key),children:e.label},e.key))}),m&&(0,p.jsx)(`div`,{role:`tabpanel`,id:`panel-${m.key}`,"aria-labelledby":`tab-${m.key}`,className:u.panel,children:m.content})]})},m.__docgenInfo={description:`Tabs component that allows navigating between multiple content sections.\r
\r
