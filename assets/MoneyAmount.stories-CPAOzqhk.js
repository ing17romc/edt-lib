import{n as e}from"./chunk-BneVvdWh.js";import{O as t,a as n,i as r,o as i}from"./iframe-BoT0I_bJ.js";var a,o,s=e((()=>{a=`_moneyAmount_1rc4r_1`,o={moneyAmount:a}})),c,l,u=e((()=>{t(),i(),s(),c=r(),l=({amount:e,currency:t=`USD`,decimals:r=2,locale:i=`es-CO`,showCurrency:a=!0,className:s,...l})=>{let u=new Intl.NumberFormat(i,{style:a?`currency`:`decimal`,currency:a?t:void 0,minimumFractionDigits:r,maximumFractionDigits:r}).format(e);return(0,c.jsx)(`span`,{className:n(o.moneyAmount,s),...l,children:u})},l.__docgenInfo={description:`MoneyAmount component that formats and displays monetary values.\r
\r
