...
export enum AudioAndVideoIcons {
...
export type AllIconsType = ActionIcons | AlertIcons | AudioAndVideoIcons | CommunicationIcons | ContentIcons | DeviceIcons | EditorIcons | FileIcons | HardwareIcons | ImageIcons | NavigationIcons | NotificationIcons | SocialIcons;
