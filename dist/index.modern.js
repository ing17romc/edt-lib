...
var Title = function Title(_ref) {
  ...
  var getHeadings = function getHeadings(label, secundary) {
    return secundary ? /*#__PURE__*/React.createElement("h4", {
      className: "font-bold"
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "title"
  }, getHeadings(label, secundary), /*#__PURE__*/React.createElement("div", {
    className: "line"
  }));
};
...
export default UI;
export { Button, CONSTANT, CheckButton, DatePicker, Icon, ImageButton, Menu, Modal, ModalHttpMessage, ModalNotifications, ModalViewerPDF, NavBar, Option, RadioButton, Selector, Spinner, TextArea, TextBox, TextButton, Title, funtions as functions, useCamera };
